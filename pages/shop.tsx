...
export default function ShopPage() {
  ...
  return (
    <>
      {/* Page Header */}
      <PageHeader 
        title="Buy simulator seat time in packs to save!"
        subtitle=""
        useCarbonBg={false}
      />
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center">More About Packages</h2>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg shadow-md border border-simstudio-yellow">
                ...
                <p className="text-gray-700">
                  After purchasing a package, the hours will be automatically added to your account as credits.
                  You can then use these credits when booking sessions through our booking system.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-simstudio-yellow">
                ...
                <p className="text-gray-700">
                  Yes, packages are valid for 12 months from the date of purchase. 
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md border border-simstudio-yellow">
                ...
                <p className="text-gray-700">
                  Packages are linked to individual accounts and cannot be shared. 
                </p>
              </div>
